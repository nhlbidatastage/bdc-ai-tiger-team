...
Download the notebook ['20241021 Llama3.ipynb'](https://github.com/nhlbidatastage/bdc-ai-tiger-team/blob/main/objective_1.1/notebooks/20241021%20Llama3.ipynb) from this repository, and upload it into your Terra Workspace using the Browse Workspace Files section of the Analysis tab.  Once you upload the file, click on Analysis again and open the notebook (Edit...) in the newly create Analysis Environment.
